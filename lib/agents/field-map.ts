...
export const AGENT_FIELD_MAP: Record<number, AgentFieldInfo> = {
  0: {
    ...
    fieldsWritten: ['Firma', 'Kontakt', 'Telefon', 'Decydent', 'Status → Nowy lead', 'Notatki (KRS)'],
  },
  1: {
    agentNumber: 1,
    ...
    extendedThinking: false,
    fieldsWritten: [
      'Firma', 'Kontakt', 'Telefon', 'Flota', 'Spedytorzy', 'Decydent',
      'TMS', 'Podejście TMS', 'Ból główny', 'Poprzednie próby',
      'Koszt problemu PLN/mc', 'Koszt roczny PLN/rok', 'Ocena ICP',
      'Status', 'Data discovery', 'Następny krok', 'Uwagi Agenta 1',
    ],
  },
  2: {
    agentNumber: 2,
  ...
  5: {
    agentNumber: 5,
    name: 'Agency Leaders Knowledge',
    model: 'Opus 4.8 + extended thinking',
    extendedThinking: true,
    fieldsWritten: ['Brak zapisu do Pipeline — output do ręcznego review'],
  },
  6: {
    agentNumber: 6,
    name: 'Wywiad Rynkowy',
    model: 'Opus 4.8 + extended thinking + web_search',
    extendedThinking: true,
    fieldsWritten: ['Brak zapisu do Pipeline — Intelligence Report'],
  },
}
