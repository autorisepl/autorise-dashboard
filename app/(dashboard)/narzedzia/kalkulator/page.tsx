      ...
      <div style={{ display: "flex", alignItems: "center" }}>
        <input
          ...
          style={{
            ...
            boxShadow: focused && !readOnly ? `0 0 0 3px rgba(26,86,255,0.12)` : "none",
  ...
  return (
    <div
      style={{
        ...
        overflow: "hidden",
        background: accent
          ? "linear-gradient(135deg, rgba(26,86,255,0.09) 0%, rgba(26,86,255,0.04) 100%)"
          : "var(--bg-elevated)",
        border: `1px solid ${accent ? "rgba(26,86,255,0.22)" : "var(--border)"}`,
        borderRadius: 14,
        boxShadow: accent ? "0 4px 20px rgba(26,86,255,0.08)" : "0 1px 4px rgba(0,0,0,0.04)",
      }}
    >
      {accent && (
        <div
          style={{
            ...
            width: 90,
            height: 90,
            background: "radial-gradient(circle, rgba(26,86,255,0.10) 0%, transparent 70%)",
            pointerEvents: "none",
          }}
        />
      )}
      <div
        style={{
          ...
          color: accent ? "rgba(26,86,255,0.65)" : "var(--text-tertiary)",
        }}
      >
        {label}
      </div>
...
function ClientRow({
  ...
  return (
    <button
      ...
      style={{
        padding: "12px 16px",
        background: hovered ? "var(--bg-item-hover)" : "var(--bg)",
        ...
        alignItems: "center",
        gap: 10,
        boxShadow: hovered ? `0 0 0 3px rgba(26,86,255,0.10)` : "none",
            ...
            <div style={{ position: "relative" }}>
              <button
                ...
                style={{
                  ...
                  boxShadow: clientDropdownOpen ? `0 0 0 3px rgba(26,86,255,0.12)` : "none",
                  transition: "border-color 0.15s, box-shadow 0.15s",
                }}
              >
                {clientsLoading ? (
                        ...
                        return (
                          <button
                            ...
                            style={{
                              ...
                              borderRadius: 7,
                              border: "none",
                              background: isSelected ? `rgba(26,86,255,0.08)` : "transparent",
                              cursor: "pointer",
                              textAlign: "left",
                              display: "flex",
                              alignItems: "center",
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          <button
            ...
            style={{
              width: "100%",
              padding: "12px 16px",
              background: fullMode ? "rgba(26,86,255,0.07)" : "var(--bg-elevated)",
              border: `1px solid ${fullMode ? "rgba(26,86,255,0.22)" : "var(--border)"}`,
              borderRadius: 12,
              cursor: "pointer",
          ...
          {fullMode && (
            <div
              style={{
                ...
                flexDirection: "column",
                gap: 18,
                boxShadow: "0 1px 4px rgba(26,86,255,0.07)",
              }}
            >
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <div
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 9 }}>
            <button
              ...
              style={{
                ...
                justifyContent: "center",
                gap: 8,
                boxShadow: "0 4px 18px rgba(26,86,255,0.32)",
            ...
            <button
              ...
              style={{
                padding: "13px 18px",
                background: copied ? "rgba(52,199,89,0.08)" : "var(--bg-elevated)",
                border: `1px solid ${copied ? "rgba(52,199,89,0.25)" : "var(--border)"}`,
                borderRadius: 12,
                cursor: "pointer",
