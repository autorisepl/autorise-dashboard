...
function ProfilContentInner({ displayName, roleLabel, email }: ProfilContentProps) {
...
export function ProfilContent(props: ProfilContentProps) {
  return (
    <Suspense>
      <ProfilContentInner {...props} />
    </Suspense>
  );
}
