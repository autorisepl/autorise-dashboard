...
export async function POST(req: Request) {
  try {
    ...
    if (krsEnrichment) {
      if (!output.firma_krs && krsEnrichment.firma_oficjalna) output.firma_krs = krsEnrichment.firma_oficjalna
      ...
      if (!output.vat_status && krsEnrichment.vat_status) output.vat_status = krsEnrichment.vat_status
